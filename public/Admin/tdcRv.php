                        ...
                        <div class="card-body">
                            <form id="dataEntryForm">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for="waybill_empty" class="form-label">Trip Receipt No. EMPTY <span class="text-danger">*</span></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            function setRowDataAttributes(row, record) {
                ...
                row.dataset.created_date = formatDateForDisplay(record.created_date || '');
