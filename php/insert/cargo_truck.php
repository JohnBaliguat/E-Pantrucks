...
if (
    ($e = master_validate_cargo(
        $conn, $segment, $activity, $driver, $driver_idNumber, $truck, $customer_ph,
    )) !== null
) {
    $response["message"] = $e;
    header("Content-Type: application/json");
...
$stmt->execute(db_nullable_all([
    $entry_type, $segment, $activity, $waybill_date, $waybill, $truck, $driver,
    $driver_idNumber, $customer_ph, $outside, $compound, $total_trips, $operations,
    $deliver_from, $deliver_to, $remarks, $cargo_date, $piece_rate, $billing_sku,
